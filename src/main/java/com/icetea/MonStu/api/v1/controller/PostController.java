...
public class PostController {
    ...
    @PostMapping("/filter")
    public ResponseEntity<CustomPageableResponse<com.icetea.MonStu.api.v1.dto.response.post.PostResponse>> getPostsWithfilter(@RequestBody PostFilterRequest filter, Pageable pageable) {
        Page<com.icetea.MonStu.api.v1.dto.response.post.PostResponse> page = postSvc.filter(filter,pageable);
        CustomPageableResponse<com.icetea.MonStu.api.v1.dto.response.post.PostResponse> result = CustomPageableResponse.mapper(page);
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(result);
    }
    ...
    public ResponseEntity<com.icetea.MonStu.api.v1.dto.response.post.PostResponse> findWithPostsAndLog(@PathVariable Long id ){
        com.icetea.MonStu.api.v1.dto.response.post.PostResponse result = postSvc.findWithMemberAndLogById(id);
        return ResponseEntity
                .status(HttpStatus.OK)
                .body( result );
    }
