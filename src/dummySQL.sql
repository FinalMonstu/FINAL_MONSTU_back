...
VALUES
    ( 10009,  '첫 번째 게시글',         'MonStu 서비스에 오신 것을 환영합니다.',             '2025-05-01 08:00:00','2025-05-01 08:00:00','PUBLIC',    TRUE,        9999,        NULL),
    ...
    (10002,  'GraphQL 소개',          'GraphQL을 사용한 효율적인 API 설계',              '2025-05-04 10:20:00','2025-05-04 10:20:00','PUBLIC',    TRUE,        9999,       NULL),
    (10003,  'Docker 사용법',         'Docker로 개발 환경을 컨테이너화하는 방법',         '2025-05-04 14:30:00','2025-05-04 14:30:00','PUBLIC',    FALSE,       9999,       NULL),
    (10004,  'JPA 활용 팁',           'QueryDSL을 이용한 동적 쿼리 작성 예제',           '2025-05-05 09:15:00','2025-05-05 09:15:00','PUBLIC',    TRUE,        9999,       NULL),
    (10005,  '테스트 주도 개발(TDD)',  'JUnit과 Mockito를 활용한 테스트 작성 전략',     '2025-05-05 11:00:00','2025-05-05 11:00:00','PUBLIC',    TRUE,        10000,       NULL),
    (10006,  'API 문서화',            'Swagger로 REST API 문서를 자동 생성하기',         '2025-05-06 13:45:00','2025-05-06 13:45:00','PUBLIC',    FALSE,       10000,       NULL),
    (10007,  'CI/CD 파이프라인',      'GitHub Actions로 배포 자동화 설정하기',           '2025-05-06 16:30:00','2025-05-06 16:30:00','PUBLIC',    TRUE,        10001,       NULL),
    (10008,  '웹소켓 구현',            'Spring Boot와 SockJS로 실시간 채팅 만들기',      '2025-05-07 09:00:00','2025-05-07 09:00:00','PUBLIC',    TRUE,        10001,       NULL),
...
Ay',      '2025-05-07 09:00:00','2025-05-07 09:00:00','PUBLIC',    TRUE,        10001,       NULL);
